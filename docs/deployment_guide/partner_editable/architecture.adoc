...
image::../docs/images/jfrog-saas-log-collector-architecture-diagram.png[Architecture]
...
* AWS Secrets Manager to store the JFrog Platform admin token and the Splunk HEC token.
